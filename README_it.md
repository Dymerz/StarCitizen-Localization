...
|--------------------------|------------|-------|
| Inglese                 | ![Static Badge](https://img.shields.io/badge/4.2.0-PTU-brightgreen) | Importato dai file di gioco |
| Francese - Francia      | ![Static Badge](https://img.shields.io/badge/4.1.1-LIVE-brightgreen) | Generato da [circuspes.fr](https://traduction.circuspes.fr) |
| Tedesco - Germania      | ![Static Badge](https://img.shields.io/badge/4.2.0-PTU-brightgreen) | Qui |
| Portoghese - Brasile    | ![Static Badge](https://img.shields.io/badge/4.2.0-PTU-brightgreen) | Qui |
