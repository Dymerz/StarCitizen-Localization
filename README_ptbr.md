...
|--------------------------|-----------|-------|
| Inglês                  | ![Static Badge](https://img.shields.io/badge/4.0.1-PTU-brightgreen) | Importado dos arquivos do jogo |
...
| Alemão - Alemanha       | ![Static Badge](https://img.shields.io/badge/4.0.1-PTU-brightgreen) | Aqui |
| Português - Brasil      | ![Static Badge](https://img.shields.io/badge/4.0.1-PTU-brightgreen) | Aqui |
