...
|--------------------------|-----------|--------|
| English                  | ![Static Badge](https://img.shields.io/badge/4.8.2-LIVE-brightgreen) | Imported from game files |
...
| Portuguese - Brazil      | ![Static Badge](https://img.shields.io/badge/4.8.2-LIVE-brightgreen) | Here |
