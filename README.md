...
|--------------------------|-----------|--------|
| English                  | ![Static Badge](https://img.shields.io/badge/4.1.0-PTU-brightgreen) | Imported from game files |
...
| Portuguese - Brazil      | ![Static Badge](https://img.shields.io/badge/4.1.0-PTU-brightgreen) | Here |
