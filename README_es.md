...
| ----------------------- | ------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------- |
| Inglés                  | ![Static Badge](https://img.shields.io/badge/4.2.0-PTU-brightgreen)   | Importado de archivos del juego                                                                                                     |
...
| Alemán (Alemania)       | ![Static Badge](https://img.shields.io/badge/4.2.0-PTU-brightgreen)   | Aquí                                                                                                                                |
| Portugués (Brasil)      | ![Static Badge](https://img.shields.io/badge/4.2.0-PTU-brightgreen)   | Aquí                                                                                                                                |
