...
| ----------------------- | ------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------- |
| Inglés                  | ![Static Badge](https://img.shields.io/badge/4.3.2-LIVE-brightgreen)   | Importado de archivos del juego                                                                                                     |
...
| Portugués (Brasil)      | ![Static Badge](https://img.shields.io/badge/4.3.2-LIVE-brightgreen)   | Aquí                                                                                                                                |
