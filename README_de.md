...
|--------------------------|-------------|--------|
| Englisch                | ![Static Badge](https://img.shields.io/badge/4.2.0-LIVE-brightgreen) | Aus Spieldateien importiert |
| Französisch - Frankreich | ![Static Badge](https://img.shields.io/badge/4.2.0-LIVE-brightgreen) | Generiert von [circuspes.fr](https://traduction.circuspes.fr) und [SPEED0U/Scefra](https://github.com/SPEED0U/Scefra) |
| Deutsch - Deutschland   | ![Static Badge](https://img.shields.io/badge/4.2.0-LIVE-brightgreen) | Hier |
| Portugiesisch - Brasilien| ![Static Badge](https://img.shields.io/badge/4.2.0-LIVE-brightgreen) | Hier |
