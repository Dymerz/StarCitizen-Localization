...
|--------------------------|----------------|--------|
| Anglais                 | ![Static Badge](https://img.shields.io/badge/4.10.0-LIVE-brightgreen) | Importé des fichiers du jeu |
| Français - France       | ![Static Badge](https://img.shields.io/badge/4.10.0-LIVE-brightgreen) | Généré depuis [circuspes.fr](https://traduction.circuspes.fr) |
| Allemand - Allemagne    | ![Static Badge](https://img.shields.io/badge/4.2.0-LIVE-orange) | Ici |
| Portugais - Brésil      | ![Static Badge](https://img.shields.io/badge/4.10.0-LIVE-brightgreen) | Ici |
| Italien - Italie        | ![Static Badge](https://img.shields.io/badge/4.10.0-LIVE-brightgreen) | [GattoMatto](https://robertsspaceindustries.com/citizens/GattoMatto) et [MrRevo](https://robertsspaceindustries.com/citizens/MrRevo) |
