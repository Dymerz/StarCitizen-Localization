...
|--------------------------|----------------|--------|
| Anglais                 | ![Static Badge](https://img.shields.io/badge/4.0.1-PTU-brightgreen) | Importé des fichiers du jeu |
...
| Allemand - Allemagne    | ![Static Badge](https://img.shields.io/badge/4.0.1-PTU-brightgreen) | Ici |
| Portugais - Brésil      | ![Static Badge](https://img.shields.io/badge/4.0.1-PTU-brightgreen) | Ici |
